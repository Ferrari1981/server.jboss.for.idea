...
public class Fio_templateJsonDeserializer extends JsonMainDeseirialzer {
 ...
 return  РезультатОперацииBurkUPDATE.size();
    ...
    Integer ОбновлениеДанных(@NonNull Context context,
        ...
        try{
            ...
            String  SQlOperUpdate=  " UPDATE "+имяТаблицаAsync+" SET  id=?, " +
                    " uuid=?, fio_template =?,fio_uuid=? ,  " +
                    " date_update=?,    user_update=? ,current_table=? , status_send=?   WHERE  uuid=?  ;";
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("fio_template").longValue());//"uuid"
            sqLiteStatementInsert.bindLong(4, jsonNodeParentMAP.get("fio_uuid").longValue());//"uuid"
