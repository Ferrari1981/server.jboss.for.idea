...
public class Сhat_usersJsonDeserializer extends JsonMainDeseirialzer {
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "INSERT INTO "+имяТаблицаAsync+"" +
                        "  ( _id, name, rights ,telephone , date_update,     current_table ,  locked , uuid )    " +
                        " VALUES (?,?,?,?,?,?,?,?);";
    ...
    Integer ОбновлениеДанных(@NonNull Context context,
        ...
        try{
            ...
            String  SQlOperUpdate=  " UPDATE "+имяТаблицаAsync+" SET   " +
                    " name=?, rights =?,telephone=? ,  " +
                    " date_update=?,     current_table=? ,  locked =?, uuid=?   WHERE  uuid=?  ;";
