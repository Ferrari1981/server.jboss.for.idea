...
public class Vid_tcJsonDeserializer extends JsonMainDeseirialzer {
                             ...
                             .doOnNext(new Consumer<List<JsonNode>>() {
                                 ...
                                 public void accept(List<JsonNode> jsonNodes) throws Throwable {
                                     ...
                                     Flowable.fromIterable(jsonNodes)
                                             .onBackpressureBuffer()
                                             .blockingIterable().forEach(new java.util.function.Consumer<JsonNode>() {
                                         @Override
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  " INSERT INTO "+имяТаблицаAsync+"  " +
                        "  (    _id,  name ,date_update,uuid, user_update ,current_table  )  " +
                        " VALUES ( ?,?,?,?,?,? ) ;";
    ...
    Integer ОбновлениеДанных(@NonNull Context context,
        ...
        try{
            ...
            String  SQlOperUpdate=  " UPDATE "+имяТаблицаAsync+" SET   " +
                    " name =?,date_update=?,uuid=?, user_update=? ,current_table=?    "+
                    "   WHERE  uuid=?  ;";
