 ...
 return  РезультатОперацииBurkUPDATE.size();
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  " INSERT INTO "+имяТаблицаAsync+"  " +
                        " (     _id,  cfo ,vid_trasport,dateorders, " +
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("cfo").intValue());//"uuid"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("vid_trasport").intValue());//"uuid"
            sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("dateorders").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(5, jsonNodeParentMAP.get("gos_nomer").intValue());//"uuid"
            sqLiteStatementInsert.bindString(6, jsonNodeParentMAP.get("number_order").asText().trim());//"date_update"
            sqLiteStatementInsert.bindLong(7, jsonNodeParentMAP.get("status").intValue());//"uuid"
            ...
            sqLiteStatementInsert.bindLong(10, jsonNodeParentMAP.get("user_update").intValue());//"uuid"
