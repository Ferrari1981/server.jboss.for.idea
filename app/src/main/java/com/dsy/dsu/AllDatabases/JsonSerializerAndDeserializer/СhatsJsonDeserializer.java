...
public class СhatsJsonDeserializer extends JsonMainDeseirialzer {
        ...
        try{
            this.context=context;
                ...
                String  SQlOperInsert=  "INSERT INTO "+имяТаблицаAsync+"" +
                        " (   _id, user_update, date_update ,uuid ,  id_user,name,      current_table,  uuid_parent  )" +
                        " VALUES(?,?,?,?,?,?,?,?);";
    ...
    Integer ОбновлениеДанных(@NonNull Context context,
        ...
        try{
            ...
            String  SQlOperUpdate=  " UPDATE "+имяТаблицаAsync+" SET  _id=?," +
                    " user_update=?, date_update =?,uuid=? ,  " +
                    " id_user=?,name=?,      current_table=? ,  uuid_parent =?    WHERE  uuid=?  ;";
