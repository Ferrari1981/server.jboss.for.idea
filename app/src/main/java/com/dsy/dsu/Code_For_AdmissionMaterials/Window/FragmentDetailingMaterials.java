    ...
    class MyRecycleViewAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        private void МетодНазваниеЦФОДетализация(@NonNull TableLayout tableLayoutРодительская) {
            try {
                ...
                String НазваниеЦФОДляДетализации= Optional.ofNullable(cursor.getString(cursor.
        ...
        private void МетодДанныеМатериалДетализация(@NonNull TableLayout tableLayoutРодительская ) {
            try{
                ...
                // TODO: 10.11.2022  данные для название ЦФО
                String nomenvesovДетадизации= Optional.ofNullable(cursor.getString(cursor.
                ...
                // TODO: 10.11.2022  данные для название ЦФО
                Integer КоличествоДетадизации= Optional.ofNullable(cursor.getInt(cursor.
