...
public class MainActivity_Face_Start_BeforeDeleting extends AppCompatActivity {
            ...
            try{
                ...
                if ( ФиналПолучаемРазницуМеждуДатами <20 && date_update!=null && success_users!=null  && success_login!=null  ) {
                    ...
                    if (СтатусРаботыСервера ==true) {
                        Интент_ЗапускаетFaceApp.setClass(getApplicationContext(),  MainActivity_Face_Start_BeforeDeleting.class); //MainActivity_Visible_Async //MainActivity_Face_App
